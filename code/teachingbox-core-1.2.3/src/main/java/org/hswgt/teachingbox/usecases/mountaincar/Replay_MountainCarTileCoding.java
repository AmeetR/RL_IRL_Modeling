...
/**
 * This class uses the learned Q-function from @MountainCarTileCoding and starts
 * 10 experiments with random start positions. Each episode is visualized. 
 * As well all performed trajectories.
 */
public class Replay_MountainCarTileCoding
{
	/**
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        // setup Q-Function
        QFeatureFunction Q = ObjectSerializer.load("data/mc-tileCoding.Q");
		...
		trajectoryPlotter.setTitle("MountainCar TileCoding trajectories");
