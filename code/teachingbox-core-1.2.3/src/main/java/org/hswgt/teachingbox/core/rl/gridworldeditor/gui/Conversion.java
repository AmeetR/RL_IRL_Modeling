...
public class Conversion implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 5325106474854255049L;
	 ...
	 * @param n The byte
	 * @return The byte[] array containing n
	 */
	 ...
	 * @param n The short variable
	 * @return The byte array
	 */
	public static byte[] convertToByteArray(short n) {
		n = (short) (n ^ ((short) 0x8000)); // flip MSB because "short" is
		// signed
		byte[] key = new byte[2];
		pack2(key, 0, n);
		return key;
	...
	public static long convertToLong(byte[] buf) {
		...
		value = (value ^ 0x8000000000000000L); // flip MSB because "long" is
		// signed
		return value;
	}
